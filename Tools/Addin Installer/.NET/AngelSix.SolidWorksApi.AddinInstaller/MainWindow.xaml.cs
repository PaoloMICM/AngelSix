...
using Icm.AngelSix.SolidWorksApi.AddinInstaller.Services;

namespace Icm.AngelSix.SolidWorksApi.AddinInstaller
{
    /// <summary>
    ...
    public partial class MainWindow : INotifyPropertyChanged
    {
        ...
        private void InstallAddin(string addinPath)
        {
            try
            {
                ...
                var addinInstallerService = new AddinInstallerService(addinPath);
                var retVal = addinInstallerService.Register(out var stdError);
                ...
                // Otherwise just show the results
                    ...
                    MessageBox.Show(stdError.ReadToEnd(), "Unexpected Response", MessageBoxButton.OK, MessageBoxImage.Warning);
            }
            catch (Exception ex)
            {
        ...
        private void UninstallAddin(string addinPath)
        {
            try
            {
                ...
                var addinInstallerService = new AddinInstallerService(addinPath);
                var retVal = addinInstallerService.UnRegister(out var stdError);
